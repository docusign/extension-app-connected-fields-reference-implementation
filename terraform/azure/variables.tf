...
variable "application_name" {
  ...
  type        = string
  nullable    = false
  default     = "extension-app-connected-fields"
...
variable "application_build_labels" {
  ...
  default = {
    ...
    "org.opencontainers.image.source"      = "hhttps://github.com/docusign/extension-app-connected-fields-reference-implementation"
